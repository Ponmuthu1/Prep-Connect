    ...
    <div className="app">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p>
            Social Network & Community <span className="highlight">Connect, Share, and Discover</span> for Anonymously or Not!
          </p>

          <div className="additional-content">
            <h2>Why Choose PrepConnect?</h2>
            <p>
              PrepConnect offers a unique platform for meaningful chats, both open and anonymous, prioritizing community, privacy, and knowledge exchange.
              It's perfect for users seeking deep and quality conversations.
            </p>
            <ul className="features-list">
              <li>Encrypted connections and privacy protections.</li>
              <li>Secret conversations on any topic without revealing identity.</li>
